...
// leetcode length of lastword string
class Solution {
public:
...
// count a digit that divide a number
class Solution {
public:
...
// XOR operations in an array leetcode
class Solution {
public:
...
// remove element from sorted array || leetcode
class Solution {
public:
...
// sqrt through binary search leetcode 69
class Solution {
public:
    int mySqrt(int x) {
        if(x==0) return 0;
...
// happy number leetcode second method
class Solution {
public:
    ...
    int countRatioSubarrays(vector<int>& nums, int a, int b) {
        ...
        for(int i=0;i<n;i++){
            ...
            for(int j=i;j<n;j++){
                ...
                if(odd>0){
                    long long left=1LL * even * b;
                    long long right=1LL * odd * a;
                    if(left<=right) ans++;
                }
...
public:
    int minimumSize(vector<int>& nums, int maxOperations) {
        ...
        int ans=high;
        while(low<high){
            int penalty=(high+low)/2;
            int ops = 0;
            for(int i=0;i<nums.size();i++){
                if(nums[i]>penalty){
                    if(nums[i]%penalty==0) ops+=(nums[i]/penalty)-1;
                    else ops+=nums[i]/penalty;
                }    
            }
...
2903. Find Indices With Index and Value Difference I leetcode
class Solution {
public:
...
3206. Alternating Groups I leetcode
class Solution {
public:
